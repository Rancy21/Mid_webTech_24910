...
<body>
    ...
    <h3 class = "error">${brwError}</h3>
    <h3 class = "message">${brwMessage}</h3>
            ...
            if (roomId && shelfId && roomData[roomId].shelves[shelfId]) {
                ...
                roomData[roomId].shelves[shelfId].books.forEach(book => {
                    ...
                    bookCard.innerHTML = `
                        ...
                        <button onclick="borrowBook('<%="${book.title}"%>', &quot;<%="${book.author}"%>&quot;, '<%="${roomData[roomId].code}"%>', '<%="${roomData[roomId].shelves[shelfId].category}"%>')">
                        Borrow
                      </button>
                    `;
